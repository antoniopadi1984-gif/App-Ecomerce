...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/marketing/video-lab', destination: '/creativo/video-lab', permanent: true },
      { source: '/marketing/copy-hub', destination: '/creativo/copy-hub', permanent: true },
      { source: '/marketing/static-ads', destination: '/creativo/static-ads', permanent: true },
      { source: '/marketing/landing-lab', destination: '/creativo/landing-lab', permanent: true },
      { source: '/marketing/avatars-lab', destination: '/creativo/avatars-lab', permanent: true },
      { source: '/marketing/product-brain', destination: '/creativo/product-brain', permanent: true },
      { source: '/marketing/branding', destination: '/creativo/branding', permanent: true },
      { source: '/marketing/contents', destination: '/creativo/contents', permanent: true },
      { source: '/marketing/creative-library', destination: '/creativo/creative-library', permanent: true },
