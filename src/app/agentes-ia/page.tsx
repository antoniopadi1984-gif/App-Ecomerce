        ...
        <div className="flex flex-col h-[calc(100vh-100px)] space-y-4">
            ...
            <div className="bg-white rounded-lg border border-slate-200 px-4 py-3 flex items-center justify-between shadow-xs">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xs font-black text-slate-900 uppercase tracking-tighter leading-none italic">Agentes <span className="text-indigo-600 not-italic">IA</span></h1>
                        <p className="text-[8px] text-slate-400 font-black uppercase tracking-[0.1em] mt-1 shrink-0">Neural Workforce Management</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
