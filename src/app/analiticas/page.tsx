...
export default function ProductAnalyticsPage() {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 max-w-[1600px] mx-auto p-6 pb-20">
            {/* Header Control */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-900 px-6 py-5 rounded-2xl shadow-xl border border-slate-800">
                <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <KPICard label="CVR" value={`${data.conversionRate}%`} trend={-0.2} icon={Activity} color="indigo" />
