...
async function runPipeline(
    ...
    try {
        ...
        try {
            ...
            await execAsync('/opt/homebrew/opt/ffmpeg-full/bin/ffmpeg -y -i "' + blurOnlyPath + '" -vf "subtitles=' + srtPath3 + ':force_style='FontSize=18,PrimaryColour=&H00FFFFFF,BackColour=&H80000000,BorderStyle=4,Outline=0,Shadow=0,Alignment=2,MarginV=20'" "' + subtitledPath2 + '"');
