        ...
        <div className="flex flex-col h-screen bg-[#F8FAFC]">
            <ScrollArea className="flex-1">
                <main className="max-w-[1600px] mx-auto p-6 pb-20 space-y-6">
                    ...
                    {/* Header Section */}
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/50 backdrop-blur-sm px-6 py-5 rounded-2xl border border-slate-100 shadow-xl shadow-slate-200/40">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="px-2 py-0.5 bg-indigo-50 text-indigo-600 text-[9px] font-black uppercase tracking-widest rounded-full border border-indigo-100">Financials v4</span>
                                </div>
