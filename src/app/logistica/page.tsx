...
export default function SupplyChainDashboard() {
    ...
    return (
        <div className="space-y-4 animate-in fade-in duration-1000 bg-[#F8FAFC] min-h-screen p-1 md:p-3 text-slate-900 overflow-hidden relative">
            {/* AMBIENT DECORATION */}
            ...
            <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <MetricCard icon={TrendingUp} label="Beneficio Real" value={`€${monthTotalProfit.toLocaleString()}`} subtext={`${((monthTotalProfit / (monthTotalRevenue || 1)) * 100).toFixed(1)}% margen`} color="indigo" />
                    ...
                    <Card className="bg-slate-950 border-none rounded-lg shadow-2xl h-[580px] overflow-hidden relative flex flex-col group">
                        ...
                        <div className="p-4 space-y-4 flex-1 relative z-10">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2.5">
                                    <div className="h-9 w-9 bg-indigo-600 rounded-lg flex items-center justify-center shadow-[0_0_20px_rgba(79,70,229,0.4)]">
                                        <Brain className="h-4 w-4 text-white animate-pulse" />
                                    </div>
                                    <div className="space-y-0.5">
                                        <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-white italic">Neural Engine</h3>
                                        <p className="text-[6px] font-black text-indigo-400 uppercase tracking-widest">v4.5 Enterprise</p>
                                    </div>
                                </div>
                                    ...
                                    {aiAdvice ? (
                                        ...
                                        <div className="h-[280px] flex flex-col items-center justify-center space-y-4 opacity-20 border-2 border-dashed border-white/10 rounded-2xl mx-2">
                                            <div className="relative">
                                                ...
                                                <Sparkles className="h-4 w-4 text-indigo-400 absolute -top-1 -right-1 animate-bounce" />
                                            </div>
                                ...
                                <table className="w-full text-left border-collapse table-fixed min-w-[1200px]">
                                    <thead>
                                        <tr className="bg-slate-900/95 backdrop-blur-xl text-[7px] font-black uppercase tracking-[0.2em] text-white/50 border-b border-indigo-500/10">
                                            ...
                                            <th className="p-2.5 w-32 text-center bg-indigo-600/90 text-white italic">REAL PROFIT</th>
                                        </tr>
                                    </thead>
