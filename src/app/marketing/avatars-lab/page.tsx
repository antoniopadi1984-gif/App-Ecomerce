...
export default function AvatarStudioPage() {
    ...
    const loadData = async () => {
        ...
        if (voicesRes.success) {
            setVoices(voices.length > 0 ? voices : voicesRes.voices || []);
            // Only update if voices is empty
    ...
    return (
        <div className="max-w-[1700px] mx-auto p-2 md:p-6 space-y-6 animate-in fade-in duration-700">
            ...
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white/50 glass-panel border-b border-slate-100 p-8">
                <div className="space-y-1">
                    <div className="flex items-center gap-3">
                        <div className="w-12 h-12 bg-rose-600 text-white rounded-2xl shadow-sm flex items-center justify-center">
                            <Users className="w-6 h-6" />
                        </div>
                        <h1 className="text-3xl font-black text-slate-900 uppercase italic tracking-tighter">
                            AVATAR <span className="text-rose-600 not-italic">STUDIO</span>
                        </h1>
                    </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    {!isAdding && activeTab === "profiles" && (
                        <Button
                            ...
                            className="bg-rose-600 hover:bg-rose-700 text-white rounded-2xl font-black px-6 h-12 shadow-sm text-[11px] uppercase tracking-widest transition-all hover:scale-[1.02] active:scale-95"
                        >
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}
                ...
                <TabsList className="bg-slate-200/50 p-1 rounded-2xl h-11 border border-slate-200 mb-4 w-full md:w-auto inline-flex">
                    <TabsTrigger
                        value="profiles"
                        className="px-6 rounded-xl font-black text-[10px] uppercase tracking-widest data-[state=active]:bg-white data-[state=active]:text-rose-600 data-[state=active]:shadow-sm transition-all h-9"
                    >
                ...
                <TabsContent value="profiles" className="space-y-8">
                    {isAdding && (
                        <Card className="rounded-[32px] border-slate-200 bg-white border overflow-hidden shadow-sm animate-in slide-in-from-top-4 duration-500 mb-8 max-w-4xl mx-auto">
                                ...
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <CardTitle className="text-lg font-black uppercase tracking-tighter italic text-slate-900">
                                            {editingAvatarId ? 'MODIFICAR' : 'RECLUTAR'} <span className="text-rose-600 not-italic">PERFIL NEURAL</span>
                                        </CardTitle>
                                    </div>
                                    <Button variant="ghost" onClick={() => { setIsAdding(false); setEditingAvatarId(null); }}
                                        className="rounded-full h-8 w-8 p-0 text-slate-400 hover:text-slate-900">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <div className="space-y-1.5">
                                        ...
                                        <Input
                                            ...
                                            className="rounded-xl border-slate-200 h-11 font-bold text-sm focus:ring-2 focus:ring-rose-100"
                                        />
                                    </div>
                                    <div className="space-y-1.5">
                                    ...
                                    <div className="space-y-1.5 lg:col-span-3">
                                        ...
                                        <Textarea
                                            ...
                                            className="rounded-2xl border-slate-200 min-h-[100px] font-bold text-sm focus:ring-2 focus:ring-rose-100 p-4"
                                        />
                                    ...
                                    <div className="flex flex-wrap items-center gap-6 pt-6 lg:col-span-3">
                                        <label className="flex items-center gap-2 cursor-pointer group">
                                            <input
                                                ...
                                                className="w-5 h-5 rounded-lg border-slate-200 text-rose-600 focus:ring-rose-500 transition-all cursor-pointer"
                                            />
                                            <span className="text-[10px] font-black text-slate-600 uppercase tracking-widest group-hover:text-rose-600">CANAS</span>
                                        </label>
                                        ...
                                        <label className="flex items-center gap-2 cursor-pointer group">
                                            <input
                                                ...
                                                className="w-5 h-5 rounded-lg border-slate-200 text-rose-600 focus:ring-rose-500 transition-all cursor-pointer"
                                            />
                                            <span className="text-[10px] font-black text-slate-600 uppercase tracking-widest group-hover:text-rose-600">ARRUGAS</span>
                                        </label>
                                        ...
                                        <label className="flex items-center gap-2 cursor-pointer group">
                                            <input
                                                ...
                                                className="w-5 h-5 rounded-lg border-slate-200 text-rose-600 focus:ring-rose-500 transition-all cursor-pointer"
                                            />
                                            <span className="text-[10px] font-black text-slate-600 uppercase tracking-widest group-hover:text-rose-600">IMPERFECCIONES</span>
                                        </label>
                                    </div>
                                </div>
                                <Button
                                    ...
                                    className="w-full bg-rose-600 hover:bg-rose-700 text-white rounded-xl h-12 font-black text-sm shadow-sm transition-all flex items-center justify-center gap-2 uppercase"
                                >
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 2xl:grid-cols-8 gap-4">
                        {avatars.length === 0 && !isAdding && (
                            <div className="col-span-full py-24 text-center border-2 border-dashed border-slate-200 rounded-[40px] bg-white shadow-sm">
                                ...
                                <Button
                                    onClick={() => setIsAdding(true)}
                                    className="bg-rose-600 hover:bg-rose-700 text-white rounded-2xl font-black px-8 h-12 shadow-sm text-[11px] uppercase tracking-widest"
                                >
                                    CREAR PRIMER AVATAR
                                </Button>
                            </div>
                        ...
                        {avatars.map((a) => (
                            <Card key={a.id}
                                className="group relative rounded-[28px] border-slate-200 overflow-hidden hover:shadow-sm hover:shadow-sm hover:border-rose-600/30 transition-all duration-500 bg-white border flex flex-col hover:-translate-y-2">
                                <div className="aspect-[3/4] bg-slate-100 relative overflow-hidden">
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        ...
                                        {a.status === 'GENERATING_IMAGE' && (
                                            <div className="absolute inset-0 bg-white/80 flex flex-col items-center justify-center gap-3 z-10">
                                                <div className="w-10 h-10 rounded-full border-4 border-rose-600/20 border-t-rose-600 animate-spin" />
                                                <p className="text-[10px] font-black text-rose-600 uppercase tracking-widest">Generando...</p>
                                            </div>
                                        )}
                                    </div>

                                    {/* Action Overlay */}
                                    <div className="absolute inset-0 bg-slate-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -[2px] z-20 flex flex-col justify-end p-4 gap-2">
                                        <Button
                                            className="w-full bg-white text-slate-900 hover:bg-slate-100 font-black text-[10px] uppercase tracking-widest rounded-xl h-10 shadow-sm"
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <Button
                                                variant="secondary"
                                                className="bg-white/20 hover:bg-white/30 text-white font-black text-[9px] uppercase rounded-xl h-9 border border-white/20"
                                            ...
                                            <Button
                                                variant="secondary"
                                                className="bg-rose-500/20 hover:bg-rose-500/40 text-rose-100 font-black text-[9px] uppercase rounded-xl h-9 border border-rose-500/30"
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    if (confirm('¿Eliminar avatar?')) deleteAvatarProfile(a.id).then(loadData);
                                                }}
                                            >
                                                <Trash2 className="w-3.5 h-3.5" />
                                            </Button>
                                    ...
                                    <div className="absolute top-3 left-3 z-30">
                                        <Badge className={cn(
                                            "text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-lg border-none shadow-sm",
                                            a.status === 'READY_IMAGE' ? "bg-emerald-500 text-white shadow-sm" : "bg-white/90 text-slate-600 "
                                        )}>
                ...
                <TabsContent value="studio" className="animate-in slide-in-from-right-4 duration-500">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div className="lg:col-span-5 space-y-6">
                            <Card className="rounded-[40px] border-slate-200 overflow-hidden shadow-sm bg-white border-2">
                                <CardHeader className="p-8 border-b border-slate-100">
                                    <CardTitle className="text-xl font-black uppercase italic tracking-tighter flex items-center gap-2">
                                        <Wand2 className="w-5 h-5 text-rose-500" /> PRODUCTION DIRECTOR
                                    </CardTitle>
                                ...
                                <CardContent className="p-8 space-y-8">
                                            ...
                                            <SelectContent>
                                                {avatars.map(a => (
                                                    <SelectItem key={a.id} value={a.id}
                                                        className="font-bold uppercase text-xs">{a.name}</SelectItem>
                                                ))}
                                            </SelectContent>
                                        </Select>
                                        {!selectedAvatar && (
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex justify-between items-center px-1">
                                            ...
                                            <Button
                                                ...
                                                className="text-rose-600 font-black uppercase text-[10px] h-7 px-3 hover:bg-rose-50 rounded-lg italic"
                                            >
                                        ...
                                        <Textarea
                                            ...
                                            className="min-h-[220px] rounded-3xl border-slate-100 bg-slate-50/50 p-6 text-sm font-medium leading-relaxed resize-none focus:ring-4 focus:ring-rose-100 transition-all shadow-sm border-2"
                                        />
                                    </div>
                                    ...
                                    <Button
                                        ...
                                        className="w-full bg-slate-900 hover:bg-rose-600 text-white rounded-[30px] h-20 font-black text-xl shadow-sm transition-all flex items-center justify-center gap-4 uppercase tracking-tighter"
                                    >
                        ...
                        <div className="lg:col-span-7">
                            <Card className="rounded-[40px] border-slate-200 overflow-hidden bg-slate-950 shadow-sm h-full flex flex-col relative group">
                                <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-black/80 to-transparent z-10 p-8 flex justify-between items-start pointer-events-none">
                                    <div>
                                        <Badge className="bg-rose-600 text-white border-0 font-black text-[10px] uppercase tracking-widest px-4 py-1.5 shadow-sm">STUDIO MONITOR</Badge>
                                    ...
                                    {generatedVideoUrl ? (
                                        ...
                                        <div className="flex flex-col items-center gap-8 text-center p-12 animate-in zoom-in duration-700">
                                            <div className="relative group/camera">
                                                <div className="absolute -inset-10 bg-rose-500/10 rounded-full blur-3xl opacity-0 group-hover/camera:opacity-100 transition-opacity" />
                                                <div className="w-32 h-32 bg-white/5 border border-white/10 rounded-[3rem] flex items-center justify-center relative rotate-3 group-hover/camera:rotate-12 transition-transform duration-700 shadow-sm glass-panel">
                                ...
                                {generatedVideoUrl && (
                                    <div className="absolute inset-x-0 bottom-0 p-8 bg-gradient-to-t from-black/90 via-black/40 to-transparent z-10 flex justify-center gap-4">
                                        <Button className="bg-rose-600 hover:bg-rose-700 text-white font-black uppercase text-[10px] tracking-[0.2em] px-8 h-12 rounded-[20px] shadow-sm">
                                            EXPORTAR MASTER 4K
                                        </Button>
