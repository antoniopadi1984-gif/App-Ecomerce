...
import { getProductResearch, generateRealAvatarResearch, saveAvatarResearch } from "./actions";
...
export default function AvatarsClient({ initialProducts }: AvatarsClientProps) {
