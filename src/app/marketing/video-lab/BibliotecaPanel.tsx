            ...
            <div className="flex-1 flex flex-col gap-4 min-w-0 bg-white/40 rounded-[2.5rem] border border-slate-100/50 shadow-sm p-4 overflow-hidden relative">
                ...
                <div className="flex items-center justify-between gap-4 shrink-0 px-2">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex bg-slate-50/50 p-1 rounded-xl border border-slate-100 shadow-sm">
                            <Button
                                variant="ghost"
                                size="icon"
                    ...
                    {loading ? (
                        <div className="h-full flex flex-col items-center justify-center gap-4 text-slate-300">
                            <div className="relative flex h-12 w-12">
                                ...
                                <div className="relative inline-flex items-center justify-center w-12 h-12 bg-white/60 rounded-2xl shadow-sm border border-slate-100">
                            ...
                            {filteredFiles.map((file) => (
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        viewMode === "grid"
                                            ? "aspect-[4/5] bg-white/40 rounded-2xl border border-slate-100/50 hover:border-rose-300 hover:shadow-sm hover:shadow-sm hover:-translate-y-1"
                                    ...
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            selectedFiles.has(file.id)
                                                ? "bg-rose-500 border-rose-500 shadow-sm scale-110"
                                    ...
                                    {viewMode === "grid" ? (
                                        <>
                                            <div className="absolute inset-0 z-0 flex items-center justify-center pb-12">
                                                {file.isFolder ? (
                                                    <div className="w-full h-full flex items-center justify-center bg-rose-50/20">
                                                        <Folder className="w-28 h-28 text-rose-500/10 fill-rose-500/5 group-hover:scale-110 transition-transform duration-500" />
                                                    </div>
                                                ) : file.thumbnailLink ? (
                                            ...
                                            {!file.isFolder && (
                                                <div className="absolute top-1/2 -translate-y-1/2 right-2 opacity-0 group-hover:opacity-100 transition-all translate-x-2 group-hover:translate-x-0 flex flex-col gap-1.5 z-20">
                                                    <Button size="icon" className="w-8 h-8 rounded-xl bg-slate-900/90 text-rose-500 hover:text-rose-400 hover:bg-slate-900 shadow-sm">
                                                        <Wand2 className="w-4 h-4" />
                                                    </Button>
                                                    <Button size="icon" className="w-8 h-8 rounded-xl bg-white/90 text-rose-500 hover:text-rose-600 hover:bg-white shadow-sm border border-slate-100">
                                            ...
                                            <div className="absolute bottom-0 inset-x-0 h-20 p-2.5 z-10 bg-gradient-to-t from-white via-white/90 to-transparent flex flex-col items-center justify-end">
                                                <div className="flex flex-col items-center gap-1 text-center w-full">
                                                    <Badge className={cn(
                                                        ...
                                                        file.isFolder ? "bg-amber-100 text-amber-700 border-amber-200" : "bg-rose-500 text-white border-none shadow-sm"
                                                    )}>
                ...
                {selectedFiles.size > 0 && (
                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-slate-900 text-white px-6 py-3 rounded-2xl shadow-sm border border-white/10 flex items-center gap-6 animate-in slide-in-from-bottom-8 duration-500 z-[60]">
                        ...
                        <div className="flex items-center gap-2">
                            <Button size="sm" className="h-9 px-4 bg-rose-500 hover:bg-rose-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-sm transition-all hover:scale-105">
