    ...
    if (!usuario) {
        return (
            ...
            >
                ...
                <div style={{ flex: 1 }}>
                    <div style={{ fontSize: "12px", fontWeight: active ? 700 : 500, color: active ? "#3b82f6" : "#0f172a" }}>
                        Sin asignar
                    </div>
                </div>
        ...
        >
            ...
            {usuario.tipo === "bot" ? (
                ...
                <div style={{
                    ...
                    background: usuario.color ?? "#e2e8f0",
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: "12px", fontWeight: active ? 700 : 500, color: active ? "#3b82f6" : "#0f172a", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                    {usuario.tipo === "bot" ? usuario.nombre : `${usuario.nombre} ${usuario.apellido ?? ""}`.trim()}
                </div>
                {usuario.rol && (
                    <div style={{ fontSize: "10px", color: "#94a3b8", textTransform: "capitalize", marginTop: "1px" }}>
                        {usuario.rol === "agente_ia" ? "Agente IA" : usuario.rol}
                    </div>
                )}
            </div>
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function GestorCell({ pedido, gestores, onAssign }: { pedido: Record<string, any>; gestores: any[]; onAssign: (id: string, gestorId: string | null) => void }) {
            ...
            <div ref={ref}>
                <div onClick={() => setOpen(!open)} style={{
                    ...
                    {gestor?.tipo === "bot" ? (
                        ...
                        <div style={{
                            ...
                            background: gestor.color ?? "#e2e8f0",
                            display: "flex", alignItems: "center", justifyContent: "center",
                ...
                {open && (
                    <div style={{
                        ...
                        <DropdownOption usuario={null} active={!gestor} onClick={() => { onAssign(pedido.id, null); setOpen(false); }} />
                        
                        <div style={{
                            fontSize: "9px", fontWeight: 900, textTransform: "uppercase",
                            color: "#94a3b8", padding: "6px 8px 2px", letterSpacing: "0.08em"
                        }}>
                            Agentes IA
                        </div>
                        {gestores.filter(g => g.tipo === "bot" || g.rol === "agente_ia").map(g => (
                            <DropdownOption key={g.id} usuario={g}
