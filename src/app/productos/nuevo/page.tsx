...
export default function NewProductPage() {
 ...
 <Button className="h-10 rounded-xl bg-rose-600 text-white hover:bg-rose-700 font-black uppercase tracking-widest text-[10px] gap-2 shadow-sm">
 ...
 <Sparkles className="w-5 h-5 text-rose-300 mb-3" />
