...
function AssetCard({ asset, onClick }: { asset: any, onClick: () => void }) {
    ...
    return (
        <div
            onClick={onClick}
            className="group glass-panel rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:shadow-indigo-500/10 hover:-translate-y-0.5 transition-transform transition-shadow transition-colors duration-300 cursor-pointer relative"
        >
