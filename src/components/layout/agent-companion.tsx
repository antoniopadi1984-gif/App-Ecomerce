...
export function AgentCompanion() {
    ...
    return (
        <div className="fixed bottom-4 right-4 z-[9999] flex flex-col items-end gap-3">
            {/* Chat Window */}
            {isOpen && (
                <div className="w-[320px] h-[450px] glass-panel rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-5 duration-300 ring-1 ring-white/50">
                    {/* Header */}
                    ...
                    {/* Input */}
                    <div className="p-2 border-t border-slate-100 bg-white/50 backdrop-blur-md">
                        <div className="flex items-center gap-2">
                            <input
                                value={input}
