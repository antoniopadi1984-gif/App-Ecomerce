          ...
          {navigation.map((item: any) => {
            ...
            return (
              <div key={item.id} className="flex flex-col gap-0.5">
                      ...
                      {hasChildren && (
                        <ChevronDown
                          ...
                          className={cn(
                            ...
                            isActive ? "rotate-180 opacity-100" : "opacity-40"
                          )}
                        />
                      )}
                    </>
                ...
                {/* SUBMENÚS (si activo y expandido) */}
                {showChildren && (
                    ...
                    {item.children.map((child: any) => {
                      ...
                      return (
                        <Link
                          ...
                          className={cn(
                            "flex items-center h-8 transition-all duration-150",
                            isSubActive
                              ? "text-[11px] border-left-2 pl-3"
                              : "text-[11px] text-[#475569] hover:bg-slate-50 pl-3"
                          )}
                          style={{
                            borderLeft: isSubActive ? `2px solid ${item.color}` : 'none',
