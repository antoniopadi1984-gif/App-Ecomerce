...
export function FraudModule({ productId }: FraudModuleProps) {
    return (
        <div className="space-y-4 animate-in fade-in duration-500">
            <div className="bg-white/50 p-4 rounded-lg border border-slate-100 shadow-sm">
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-lg bg-rose-600 flex items-center justify-center shadow-sm">
