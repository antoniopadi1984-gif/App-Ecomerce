    ...
    return (
        ...
        >
            ...
            <div className="mt-2 pt-2 border-t border-slate-100/80 flex items-center justify-between relative z-10">
                ...
                <div className="w-4 h-4 rounded-md bg-slate-50/50 flex items-center justify-center group-hover:bg-indigo-600 transition-all duration-500 transform group-hover:translate-x-0.5 group-hover:rotate-[-5deg] border border-transparent group-hover:border-indigo-400/50">
