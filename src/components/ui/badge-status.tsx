...
const statusConfig: Record<string, { label: string, color: string, bg: string }> = {
    ...
    "SHIPPED": { label: "Enviado", color: "text-indigo-800", bg: "bg-indigo-100 border-indigo-200" },
    "IN_TRANSIT": { label: "En Tránsito", color: "text-indigo-800", bg: "bg-indigo-100 border-indigo-200" },
