export const CLAUDE_PROMPTS_V3 = {
  ...
  // SOPHISTICATION LEVELS (Eugene Schwartz)
  SOPHISTICATION_LEVELS: {
    1: "Nivel 1: El primero en el mercado. Promesa directa del beneficio.",
    2: "Nivel 2: Mercado con competencia. Promesa amplificada del beneficio.",
    3: "Nivel 3: Mercado saturado de promesas. Énfasis en el MECANISMO ÚNICO (Cómo funciona).",
    4: "Nivel 4: Mercado escéptico. Mecanismo amplificado o refinado.",
    5: "Nivel 5: Mercado agotado/sofisticación total. Enfoque en la IDENTIFICACIÓN y el AVATAR, no en la promesa."
  },

  // PROMPT #5: Sales Letter (Long Form)
  // Input: { avatar, language, angle, sophisticationLevel, mechanism }
  SALES_LETTER: `
    ...
    SOPHISTICACION MERCADO: {{sophisticationLevel}}
    MECANISMO UNICO: {{mechanism}}
    ANGULO: {{angle}}
    AVATAR: {{avatar}}
    LENGUAJE: {{language}}

    ESTRUCTURA OBLIGATORIA (8 SECCIONES):
    1. El Gancho (The Hook): Interrupción de patrón agresiva basada en el nivel de sofisticación.
    2. La Agitación del Dolor: Usa el VOC literal (3 AM).
    3. La Revelación del MECANISMO ÚNICO: Explica el "{{mechanism}}" como la solución real que los demás ignoran.
    4. El Vínculo con el Avatar: Identificación profunda (Nivel 5 focus).
    5. Los Beneficios Futuros: Visualización del "Yo Ideal".
    6. La Oferta Irresistible: Presentación de la solución (Hormozi style).
