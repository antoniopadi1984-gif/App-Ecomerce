export const GEMINI_PROMPTS_V3 = {
  ...
  MASS_DESIRE_DISCOVERY: `
    ...
    ═══════════════════════════════════════════════════════════════
    INSTRUCCIÓN DE MINERÍA DE DATOS (CRÍTICO)
    ═══════════════════════════════════════════════════════════════
    Si los enlaces de Amazon incluyen secciones de "BENEFITS", "PAINS" y "Q&A", PRIORIZA estos datos.
    - Úsalos para extraer Citas Textuales (Verbatim) reales.
    - Los "BENEFITS" son la base de tus promesas de transformación.
    - Los "PAINS" son el combustible para tu "Monólogo Visceral".
    - Los "Q&A" son las objeciones que el copy DEBEE derribar preventivamente.
...
`,
      ...
      "angle_tree": [
        {
          ...
          "spencer_angle_code": "ETIQUETA_MAYUS_UNICA (ej: MIEDO_ESTATUS)",
          "concept": "Explicación densa",
          "hooks": [{ 
            "h_id": "H1",
            "text": "Titular", 
            "logic": "Psicología vinculada a la EVIDENCIA",
            "spencer_hook_code": "ANGULO_H1_VAR" 
          }],
  ...
  // PHASE VISUAL: Semantic Branding & Style Extraction
  // Input: { productPhotoUrl, productTitle }
  VISUAL_IDENTITY_EXTRACTION: `
    Actúa como un Director de Arte y Estratega de Branding Visual de Clase Mundial.
    MISION: Analizar la imagen del producto provista y definir su IDENTIDAD VISUAL ESTRATÉGICA para maximizar el Valor Percibido.

    PRODUCTO: {{productTitle}}

    ═══════════════════════════════════════════════════════════════
    TAREA FORENSE VISUAL
    ═══════════════════════════════════════════════════════════════
    1. EXTRACCIÓN DE PALETA: Identifica los colores dominantes y secundarios del producto/logo. Define códigos HEX que transmitan la emoción correcta (autoridad, salud, lujo, etc.).
    2. PSICOLOGÍA DEL COLOR: Explica por qué esa paleta es la ganadora para este nicho.
    3. ARQUITECTURA TIPOGRÁFICA: Sugiere una familia de fuentes para Titulares y otra para Cuerpo que complementen el diseño del producto.
    4. ESTILO CREATIVO (AD STYLE): Basado en la estética del producto, ¿qué estilo de anuncios debería usarse? (UGC Crudo, High-End Studio, Minimalista Apple-Style, etc.)
    5. ELEMENTOS DE CONFIANZA VISUAL: ¿Qué detalles del packaging o logo proyectan más credibilidad?
    ...
    ═══════════════════════════════════════════════════════════════
    {
      "palette": {
        ...
        "secondary": "#HEX",
        "accent": "#HEX",
        "rationale": "Breve explicación psicológica"
      },
      "typography": {
        "heading": "Nombre de Fuente (ej: Inter, Montserrat)",
        "body": "Nombre de Fuente (ej: Roboto, Open Sans)",
        "style_notes": "Cómo usar el peso y espaciado"
      },
      "visual_style": {
        "creative_direction": "Descripción del estilo de anuncios (100 palabras)",
        "lighting_and_vibe": "Tipo de luz y ambiente sugerido",
        "competitor_contrast": "Cómo diferenciarse visualmente de los líderes"
      },
      "packaging_guidelines": "Sugerencias para mejorar el valor percibido del empaque",
      "logo_critique_or_suggestion": "Análisis del logo actual o sugerencia de uno nuevo"
    }
  `
};
